...
Процедура ПриНачальномЗаполненииВидовКонтактнойИнформации(КодыЯзыков, Элементы, ТабличныеЧасти) Экспорт
	...
	// Контактная информация справочника "Залы"
	Элемент = Элементы.Добавить(); 
	Элемент.ИмяПредопределенногоВида = "СправочникЗалы";	
	Элемент.ЭтоГруппа = Истина;
	Элемент.Наименование = "Контактная информация справочника ""Залы""";
	Элемент.ИмяПредопределенныхДанных = "СправочникЗалы";
	
	Элемент = Элементы.Добавить();
	Элемент.ИмяПредопределенногоВида = "АдрессЗала";
	Элемент.Родитель = "СправочникЗалы";
	...
	Элемент.ИмяПредопределенныхДанных = "АдрессЗала";
	// Конец Контактной информации справочника "Залы"
	
	//Контактная информация справочника "Ученики"
	Элемент = Элементы.Добавить(); 
	Элемент.ИмяПредопределенногоВида = "СправочникУченики";	
	Элемент.ЭтоГруппа = Истина;
	Элемент.Наименование = "Контактная информация справочника ""Ученики""";
	Элемент.ИмяПредопределенныхДанных = "СправочникУченики";
	
	Элемент = Элементы.Добавить();
	Элемент.ИмяПредопределенногоВида = "ТелефонРодителей";
	Элемент.Родитель = "СправочникУченики";
	...
	Элемент.ИмяПредопределенныхДанных = "ТелефонРодителей";
	
	Элемент = Элементы.Добавить();
	Элемент.ИмяПредопределенногоВида = "ТелефонУченика";
	Элемент.Родитель = "СправочникУченики";
	Элемент.Тип = Перечисления.ТипыКонтактнойИнформации.Телефон;
	Элемент.МожноИзменятьСпособРедактирования = Истина;
	Элемент.РазрешитьВводНесколькихЗначений   = Истина;
	Элемент.ОтображатьВсегда        = Истина;
	Элемент.Наименование = "Телефон";
	Элемент.ИмяПредопределенныхДанных = "ТелефонУченика";
	
	Элемент = Элементы.Добавить();
	Элемент.ИмяПредопределенногоВида = "Телеграмм";
	Элемент.Родитель = "СправочникУченики";
	Элемент.Тип = Перечисления.ТипыКонтактнойИнформации.Другое;
	Элемент.МожноИзменятьСпособРедактирования = Истина;
	Элемент.ОтображатьВсегда        = Истина;
	Элемент.Наименование = "Телеграмм";
	Элемент.ИмяПредопределенныхДанных = "Телеграмм";
	// Конец Контактной информации справочника "Ученики"
	
КонецПроцедуры
Процедура ПриНачальномЗаполненииВидовКонтактнойИнформацииУчеников(КодыЯзыков, Элементы, ТабличныеЧасти) Экспорт
	...
	Элемент.ТолькоНациональныйАдрес = Истина;
	Элемент.ОтображатьВсегда        = Истина;
	Элемент.Наименование = "Телефон родителей";
	Элемент.ИмяПредопределенныхДанных = "ТелефонРодителей";
	...
	Элемент.ТолькоНациональныйАдрес = Истина;
	Элемент.ОтображатьВсегда        = Истина;
	Элемент.Наименование = "Телефон ученика";
	Элемент.ИмяПредопределенныхДанных = "ТелефонУченика";
	Элемент.ВидРедактирования  = "ПолеВводаИДиалог";
